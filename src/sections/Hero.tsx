...
export default component$(() => {
  return (
    <section title="Hero" class="hero sm:relative sm:-mt-[62px] lg:mt-0">
      <div class="wrapper pb-20 sm:pb-[60px] lg:pb-[100px] lg:relative bottom-border">
        <div class="flex items-center sm:items-start">
          <header class="relative text-center mt-[150px] sm:mt-28 sm:-mr-[30px] sm:text-left sm:z-[1] sm:flex-1 lg:basis-[58vw] lg:m-0">
